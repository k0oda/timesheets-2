...
urlpatterns = [
    ...
    path("dashboard/staff/projects/recalculate/<int:project_number>/", views.recalculate_project_records, name="recalculate_project_records"),
    path("dashboard/staff/projects/<int:session_number>/recalculate/<int:project_number>/", views.recalculate_project_records, name="recalculate_project_records"),
    ...
    path("dashboard/staff/worker/<int:worker_number>/recalculate/", views.recalculate_worker_records, name="recalculate_worker_records"),
    path("dashboard/staff/worker/<int:session_number>/<int:worker_number>/recalculate/", views.recalculate_worker_records, name="recalculate_worker_records"),
